...
unsigned char U1RxBuffer[SENSOR_MAX_BUFF_LENGTH] = {0};
unsigned char U1RxPtr = 0;

//传感器数据
unsigned int PM25_value = 0;
unsigned int PM25_value_bak = 0; //用于记录开机时PM2.5的数据
unsigned int PM1_value = 0;
unsigned int PM10_value = 0;
float HCHO_value = 0;
unsigned int display_pm25_value = 0;
float display_HCHO_value = 0;
//是否设置了PMS5003S的模式，设置为被动模式
bit is_set_senor_mode_success = 0;
...
//用户定时的种类
unsigned char user_timer_type = 0;
...
unsigned char debug_buff_40[40] = {0};
