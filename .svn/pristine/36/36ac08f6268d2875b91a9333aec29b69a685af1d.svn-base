...
//检查超级用户
#define FOG_V2_CHECK_SUPERUSER_METHOD       HTTP_GET
#define FOG_V2_CHECK_SUPERUSER_URI          ("/YJIOT/device/checkdevicesuperuser/")
//回收授权 解绑
#define FOG_V2_RECOVERY_METHOD              HTTP_POST
#define FOG_V2_RECOVERY_URI                 ("/YJIOT/device/recoverydevicegrant/")
//状态同步
#define FOG_V2_SYNC_STATUS_METHOD           HTTP_POST
#define FOG_V2_SYNC_STATUS_URI              ("/YJIOT/device/syncstatus/")
//获取设备验证码  绑定用
#define FOG_V2_GENERATE_VERCODE_METHOD      HTTP_POST
#define FOG_V2_GENERATE_VERCODE_URI         ("/YJIOT/device/generatedevicevercode/")
//获取服务器时间
#define FOG_V2_GET_SERVER_TIME              HTTP_GET
#define FOG_V2_GET_SERVER_TIME_URI          ("/YJIOT/device/servertime/")
//发送数据
#define FOG_V2_SEND_EVENT_METHOD            HTTP_POST
...
//OTA上报
#define FOG_V2_OTA_UPLOAD_LOG               HTTP_POST
#define FOG_V2_OTA_UPLOAD_URI               ("/YJIOT/device/otauploadlog/")
//筹码确认chips_confirm
#define FOG_V2_CHIPS_CONFIRM_METHOD           HTTP_POST
#define FOG_V2_CHIPS_CONFIRM_URI              ("/YJIOT/device/chipsConfirm/")
//检测结果上传
#define FOG_V2_EXAM_UPLOAD_METHOD           HTTP_POST
#define FOG_V2_EXAM_UPLOAD_URI              ("/YJIOT/device/saveExamItem/")

//modbus设备关联
#define FOG_V2_DEVIE_RELATION_METHOD           HTTP_POST
#define FOG_V2_DEVIE_RELATION_URI              ("/YJIOT/device/devRelationAdd/")
