...
{
    static unsigned char times_1ms = 1 * TIMER_BASE;
    static unsigned char times_2ms = 2 * TIMER_BASE;
    static unsigned char times_10ms = 10 * TIMER_BASE;
    static unsigned char times_100ms = 100 * TIMER_BASE;
    static unsigned int times_1s = 1000 * TIMER_BASE;
