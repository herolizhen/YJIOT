...
//    }
    ...
    {   
        memset(U0RxBuffer,0,U0RxBuff_MAXSIZE);
        U0RxPtr = 0; 
        return 0;
    }
            ...
            //if( i < wifi_buff_index)
            {
               ...
               //do something
                ...
                {                  
                    ...
                    {
                        //处理完数据了
                        memset(wifi_data_buff,0,wifi_buff_index);
                        wifi_buff_index = 0;                    
                    }   
                    else
                    {
                        ...
                        memset(wifi_data_buff + wifi_buff_index,0,index_temp - wifi_buff_index);
...
void f_0x41_data(void)
{
    ...
    for(i = 0;i < SENSOR_NUM;i++)
    {
        if(i == 0)
        {
            cfloat.f = display_pm25_value;
            sensor_key = 'P';
        }
        else if(i == 1)
        {
            cfloat.f = (float)PM1_value;
            sensor_key = 'Z';
        }
        else if(i == 2)
        {
            cfloat.f = (float)PM10_value;
            sensor_key = 'O';
        }
        else if(i == 3)
        {
            cfloat.f = (float)HCHO_value;
            sensor_key = 'J';
        }       
