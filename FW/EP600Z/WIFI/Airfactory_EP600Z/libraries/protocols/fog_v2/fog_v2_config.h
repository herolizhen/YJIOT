...
//FOG_V2_PRODUCT_ID、FOG_V2_REPORT_VER、FOG_V2_REPORT_VER_NUM此处注释掉，分别在各个工程的user_config.h中重新定义
    //#define FOG_V2_PRODUCT_ID               ("034ced22-f987-11e6-9d95-00163e103941")    //云端建立产品得到的 产品ID
    //#define FOG_V2_PRODUCT_ID               ("2624f1a2-19c9-11e7-9baf-00163e120d98")    //李喜超EP产品ID
    //#define FOG_V2_PRODUCT_ID               ("dcb44768-2f06-11e7-9baf-00163e120d98")    //李喜超EP产品ID
    //#define FOG_V2_PRODUCT_ID               ("e8ee571e-1e7e-11e7-9d95-00163e103941")    //许勇的 产品ID
...
#define FOG_V2_DEVICE_SN                ("MXCHIP3165")                  //芯片SN 默认为MXCHIP

//#define FOG_V2_HTTP_DOMAIN_NAME         ("v2.fogcloud.io")          //HTTP服务器地址
//#define FOG_V2_HTTP_PORT_SSL            (443)   //fog v2 http SSL端口
//#define HTTP_REQ_LOG                    (1)     //1:enable 0:disable

//#define FOG_V2_HTTP_DOMAIN_NAME         ("io.bjyjyz.com")          //HTTP服务器地址
#define FOG_V2_HTTP_DOMAIN_NAME         ("www.yjiot.net")          //HTTP服务器地址
#define FOG_V2_HTTP_PORT_SSL            (443)   //fog v2 http SSL端口
#define HTTP_REQ_LOG                    (1)     //1:enable 0:disable
...
//#define FOG_V2_MQTT_DOMAIN_NAME         ("io.bjyjyz.com")  //MQTT服务器地址
#define FOG_V2_MQTT_DOMAIN_NAME         ("www.yjiot.net")  //MQTT服务器地址
//#define FOG_V2_MQTT_DOMAIN_NAME         ("tomcata.yjiot.net")  //MQTT服务器地址
#define FOG_V2_MQTT_PORT_SLL            (8443)  //fog v2 MQTT SSL端口
#define FOG_V2_MQTT_PORT_NOSLL          (1883)  //fog v2 MQTT 非SSL端口
#define MQTT_CLIENT_SSL_ENABLE          (0)     //1:enable 0:disable (EMW3165的ROM较小 建议设置为0)
#define FOG_MQTT_DEBUG                  (1)     //MQTT打印信息开关
