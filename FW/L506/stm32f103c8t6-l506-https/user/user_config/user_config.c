...
{  
    ...
    if(config_rx_index == 92)
    {
        for(position = 0;position < config_rx_index;position++)
        {
            printf("%x ",user_config_rx_buff[position]);
        }
        printf("\r\n");
...
//    ret = write_user_config(&user_config,partition0);
//  
//    if(ret != 0)
//    {
//        printf("write_user_config fail\r\n");
//        return;
//    }
    
    //read_user_config(partition0);
} 
