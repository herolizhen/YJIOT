...
#define WAIT_MQTT_INIT_RES_MAX_TIME         (L506_CMD_TIMEOUT_TIME + (3*1000))
#define WAIT_MQTT_GET_STATUS_RES_MAX_TIME         (L506_CMD_TIMEOUT_TIME + (1*1000))

#define MQTT_INIT_TRY_MAX_TIME                3
...
//void L506_mqtt_message_check(void);
