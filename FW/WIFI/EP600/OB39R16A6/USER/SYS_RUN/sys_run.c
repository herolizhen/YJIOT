...
//    unsigned long nowtimes = 0;
    ...
    if(cost_info.IsCostType == 1 && cost_info.IsHavetime == 1 && cost_info.IsChargeStart == 1)
    {
    ...
    if(cost_info.IsCostType == 1 && cost_info.IsHavetime == 0)
    {       
