...
const char* device_man_check_body = "{\"examId\":\"%s\",\"deviceId\":\"%s\",\"type\":\"2\",\"examItems\":[{\"examItem\":\"PWK\",\"result\":%d},{\"examItem\":\"QK\",\"result\":%d},{\"examItem\":\"LK\",\"result\":%d},{\"examItem\":\"MK\",\"result\":%d},{\"examItem\":\"HK\",\"result\":%d},{\"examItem\":\"TK\",\"result\":%d},{\"examItem\":\"MDK\",\"result\":%d}]}";
...
start_device_check_confirm:
    ...
    http_body = malloc(HTTP_BODY_SIZE);
    if(http_body == NULL)
    {
        goto exit;
    }
    memset(http_body, 0, HTTP_BODY_SIZE);
