...
void fog_v2_ota(void)
{
    ...
    /* Create a new thread */
    //mico原程序该线程栈空间0x2800，因为提前开启了其他线程，会导致栈问题无法OTA，此线程栈大小改为0x1800
    err = mico_rtos_create_thread( NULL, MICO_APPLICATION_PRIORITY, "FOG_V2_OTA", fog_ota_thread, 0x1800, (uint32_t)url );
