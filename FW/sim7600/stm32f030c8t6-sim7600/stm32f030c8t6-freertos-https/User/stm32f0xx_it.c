...
extern uint8_t uart_sim7600_rx_buff[UART_SIM7600_RX_BUFF_SIZE];
void USART2_IRQHandler(void)
{
    if(USART_GetITStatus(USART2, USART_IT_RXNE) != RESET)
    {          
        if(uart_sim7600_rx_index < UART_SIM7600_RX_BUFF_SIZE)
        {
            uart_sim7600_rx_buff[uart_sim7600_rx_index++] = USART_ReceiveData(USART2); 
        }
        else
        {
            memset(uart_sim7600_rx_buff,0,UART_SIM7600_RX_BUFF_SIZE);
